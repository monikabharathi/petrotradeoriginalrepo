...
@Component({
  selector: 'app-viewauthorizeprofile',
  templateUrl: './viewauthorizeprofile.component.html',
  styleUrls: ['./viewauthorizeprofile.component.css']
})
export class ViewauthorizeprofileComponent implements OnInit {
  profileData: any;
...
addAuthProfile()
{
  const postData = {
   ...
   const subUrl='authProfile?profileid='+this.profileData.profileid+'&purpose='+'auth';
 ...
 addDeAuthProfile()
{
  const postData = {
   ...
   const subUrl='authProfile?profileid='+this.profileData.profileid+'&purpose='+'deauth';
    //Sending The Added Values For Product
