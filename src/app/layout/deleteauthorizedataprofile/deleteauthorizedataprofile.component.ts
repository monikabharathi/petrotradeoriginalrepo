...
@Component({
  selector: 'app-deleteauthorizedataprofile',
  templateUrl: './deleteauthorizedataprofile.component.html',
  styleUrls: ['./deleteauthorizedataprofile.component.css']
})
export class Deleteauthorizedataprofile implements OnInit {
  filter:any;
  config: any;
  parentmenu: any = {};
  collection = { data: [] };
  ...
  getProfileAuthrized(){
    ...
    console.log(' Sending Request Get waiting for authorize priofile list : ' + JSON.stringify(postData));
    this.rest.sendPostRequest('gettingDelprofilewaitforAuth',JSON.stringify(postData))
      .subscribe(
